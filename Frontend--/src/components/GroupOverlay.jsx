...
function GroupOverlay({ setIsModelOpen, users }) {
    ...
    const submitHandler = async function (event) {
        ...
        if (groupName == "") {
            ...
            try {
                ...
                await creatGroupChat(accessToken, selectedUser, groupName ,profilePic);
    ...
    return (
        <div style={{
            ...
            id="crud-modal" tabIndex="1" aria-hidden="true" className="hide-scrollbar flex overflow-y-auto overflow-x-hidden fixed justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                    ...
                                    <div key={userItr.id} className="bg-gray-600 text-white flex items-center justify-between mb-2 p-2 rounded hover:bg-gray-100 hover:text-gray-800">
                                        <label className="flex items-center">
                                            <input
                                                ...
                                                value={userItr.id}
                                                checked={selectedUser.includes(userItr.id)} // Correctly bind to selectedUser
