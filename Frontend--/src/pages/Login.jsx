  ...
  return (
    <>
      <div className="font-[sans-serif]   bg-white flex items-center justify-center md:h-screen p-4">
        <div className="shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)]  bg-blue-100 max-w-6xl max-md:max-w-lg rounded-md p-6">
          <Link to="#"><img
            ...
            <form className="md:max-w-md w-full mx-auto">
              ...
              <div>
                <div className="relative flex items-center">
                  <input value={userName} onChange={onChangeHandler} name="email" type="text" required className=" bg-blue-100 w-full text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter email" />
              ...
              <div className="mt-8">
                <div className="relative flex items-center">
                  <input value={password} onChange={onChangeHandler} name="password" type={passwordInput} required className="bg-blue-100  w-full text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter password" />
              ...
              <div className="mt-12">
                <button onClick={handleSubmit} type="button" className=" w-full shadow-xl py-2.5 px-5 text-sm font-semibold rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
                  Sign in
                </button>
