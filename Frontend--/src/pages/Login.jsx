...
function Login() {
  ...
  // const handleSubmit = async (event: React.htmlFormEvent) => {
            ...
            <form className="md:max-w-md w-full mx-auto">
              ...
              <div>
                <div className="relative flex items-center">
                  <input name="email" type="text" required className=" bg-blue-100 w-full text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter email" />
              ...
              <div className="mt-8">
                <div className="relative flex items-center">
                  <input  name="password" type={passwordInput} required className="bg-blue-100  w-full text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter password" />
